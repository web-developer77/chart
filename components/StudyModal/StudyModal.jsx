...
class StudyModal extends React.Component {
        ...
        componentWillMount(){
          this.context.state = this.context[0];
          this.context.dispatch = this.context[1];
        }
	...
	componentWillReceiveProps(nextProps){
		if(this.context.state.studyHelper !== nextProps.studyHelper && nextProps.studyHelper !== null){
			this.setState({
	...
	render() {
		...
		if (!this.context.state.showStudyModal || !this.context.state.studyHelper) return <span></span>
